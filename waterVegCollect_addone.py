...
#打开水菜汇总表
df = pd.read_excel(r"D:\Data\新发地菜价\新发地水菜价格汇总.xlsx", sheet_name='水菜')
print(df.head())

docName = '新发地水菜价格表-20181231.xls'
...
writer = pd.ExcelWriter('D:\Data\新发地菜价\新发地水菜价格汇总.xlsx')
df.to_excel(excel_writer=writer, sheet_name='水菜', index=False)
writer.save()
writer.close()
print('现在可以关了')
